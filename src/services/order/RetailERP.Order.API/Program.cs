...
using RetailERP.Order.Infrastructure.Data;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "RetailERP Order API", Version = "v1" });
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "RetailERP Order API v1");
    c.RoutePrefix = "swagger";
    c.DocumentTitle = "RetailERP Order API";
...
Log.Information("Order Service starting on {Urls}", builder.Configuration["Urls"] ?? "http://localhost:5004");
app.Run();
